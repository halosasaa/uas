...
-- ----------------------------
-- Table structure for jenis_menu
-- ----------------------------
...
-- ----------------------------
-- Records of jenis_menu
-- ----------------------------
INSERT INTO `jenis_menu` VALUES (1, 'Makanan', 'false', '2023-07-24 10:05:29', '2023-07-24 10:05:29');
INSERT INTO `jenis_menu` VALUES (2, 'Minuman', 'false', '2023-07-24 10:05:34', '2023-07-24 10:05:34');
INSERT INTO `jenis_menu` VALUES (3, 'Snack', 'false', '2023-07-24 10:05:52', '2023-07-24 10:05:52');
...
CREATE TABLE `karyawan`  (
  ...
  `alamat_karyawan` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `jenis_kelamin_karyawan` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `deleted` enum('false','true','') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'false',
  `created_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `menu`  (
  ...
  `stok_menu` int NULL DEFAULT NULL,
  `deleted` enum('false','true','') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'false',
  `created_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  ...
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `id_kategori`(`id_jenis` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 4 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, 1, 'Bakso', 50, 'false', NULL, NULL, 10000, NULL);
INSERT INTO `menu` VALUES (2, 2, 'Lemon Tea', 50, 'false', NULL, NULL, 5000, NULL);
INSERT INTO `menu` VALUES (3, 3, 'Ice Cream', 50, 'false', NULL, NULL, 5000, NULL);
...
CREATE TABLE `pembeli`  (
  ...
  `alamat_pembeli` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `nomor_telp` varchar(12) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `jenis_kelamin_pembeli` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `deleted` enum('false','true','') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'false',
  `created_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `pembelian`  (
  `id` int NOT NULL AUTO_INCREMENT,
  `id_pembeli` int NULL DEFAULT NULL,
  `id_menu` int NULL DEFAULT NULL,
  `tanggal_pembelian` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `deleted` enum('false','true','') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT 'false',
  `created_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  `updated_at` datetime NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `id_anggota`(`id_pembeli` ASC) USING BTREE,
  INDEX `id_buku`(`id_menu` ASC) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
INSERT INTO `setting_menu` VALUES (5, 'Pembeli', NULL, 'pembeli', NULL, 1, 'ki-address-book', 'menu', 2, NULL, NULL, NULL, NULL, '2023-05-23 01:39:56');
INSERT INTO `setting_menu` VALUES (6, 'Jenis Menu', NULL, 'jenis_menu', NULL, 1, 'ki-address-book', 'menu', 1, NULL, NULL, NULL, NULL, '2023-05-23 03:37:13');
INSERT INTO `setting_menu` VALUES (7, 'Menu', NULL, 'menu', NULL, 1, 'ki-address-book', 'menu', 2, NULL, NULL, NULL, NULL, '2023-05-23 03:37:13');
INSERT INTO `setting_menu` VALUES (8, 'Karyawan', NULL, 'karyawan', NULL, 1, 'ki-address-book', 'menu', 2, NULL, NULL, NULL, NULL, '2023-05-23 02:26:30');
INSERT INTO `setting_menu` VALUES (9, 'TRANSAKSI', NULL, '#', NULL, 0, 'ki-address-book', 'label', 1, NULL, NULL, NULL, NULL, '2023-05-23 03:23:28');
INSERT INTO `setting_menu` VALUES (10, 'Pembelian', NULL, 'pembelian', NULL, 9, 'ki-address-book', 'menu', 2, NULL, NULL, NULL, NULL, '2023-05-23 03:23:28');
...
INSERT INTO `setting_route` VALUES (86, 'jenis_menu', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Jenis_menu\\Jenis_menuController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (87, 'karyawan', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Karyawan\\KaryawanController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (88, 'menu', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Menu\\MenuController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (89, 'pembeli', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Pembeli\\PembeliController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (90, 'transaksi', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Transaksi\\TransaksiController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (91, 'setting_menu', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Setting_menu\\Setting_menuController', '', '', 'false', NULL, NULL);
INSERT INTO `setting_route` VALUES (92, 'pembelian', 'web', 'resources', 'App\\Http\\Controllers\\Back\\Pembelian\\PembelianController', '', '', 'false', NULL, NULL);
